<?php
    $aid=$_SESSION['ad_id'];
    $ret="select * from hss_admin where ad_id=?";
...
<div class="navbar-custom">
    ...
    <div class="logo-box">
        <a href="admin_dashboard.php" class="logo text-center">
            <span class="logo-lg">
                <img src="assets/images/logo-light.png" height="34px" alt="not found" >
                <!-- <span class="logo-lg-text-light">HSS</span> -->
            </span>
            <span class="logo-sm">
                <img src="assets/images/logo-sm-white.png" height="30px" alt="not found" >
