            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Transfer Doctors</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Transfer Doctor From One Department To Another</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <?php
                            $doc_number=$_GET['doc_number'];
                            $ret="SELECT  * FROM docs WHERE doc_number='$doc_number'";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Doctor Current Working Department </label>
                                            ...
                                            <button type="submit" name="trans_dept" class="ladda-button btn btn-success" data-style="expand-right">Transfer Doctor</button>
