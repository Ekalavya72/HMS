<?php
  ...
  if(isset($_GET['delete_pay_number']))
  {
        ...
        $adn="delete from payrolls where pay_number=$id";
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Doctor Salary</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="admin_update_single_doctor_payroll.php?pay_number=<?php echo $row->pay_number;?>" class="badge badge-success"><i class="fas fa-edit "></i>Update Payroll</a>
