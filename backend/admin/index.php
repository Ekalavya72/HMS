<?php
    ...
    if(isset($_POST['admin_login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT ad_email ,ad_pwd , ad_id FROM hss_admin WHERE ad_email=? AND ad_pwd=? ");//sql to log in user
                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="index.php">
                                    <span><img src="assets/images/hss-main-logo.png" alt="" height="150px" width="auto"></span>
                                </a>
