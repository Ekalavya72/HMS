<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			$stmt->execute();
            $query1="UPDATE  users SET pat_number='$pat_number' where  u_id='$u_id'";
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Appointment Request Success";
			}
			else {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <button type="submit" name="add_patient" class="ladda-button btn btn-primary" data-style="expand-right">Appt. Request</button>
