...
<body>
    ...
    <div id="wrapper">
        ...
        <?php
                ...
                $ret="SELECT * FROM  laboratory where lab_pat_number=(SELECT pat_number FROM users where u_id=$u_id)"; 
                                    ...
                                    <div class="col-xl-5">
                                        ...
                                        <div class="tab-content pt-0">
                                            ...
                                            <div class="tab-pane active show" id="product-1-item">
                                                <img src="assets/img/medical_record.png" alt="" class="img-fluid mx-auto d-block rounded">
                                            </div>
