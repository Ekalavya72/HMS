            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="users_appointment_request.php">Appointment Request</a>
                        </li>
                        <li>
                            <a href="users_appointment_view.php"> My Appt Status</a>
                        </li>
                        <!-- <li>
                            <a href="doc_manage_patient.php">Manage Appointment</a>
                        </li> -->
                        <hr>
                        <!-- <li>
                            <a href="doc_add_presc.php">My Prescriptions</a>
                        </li> -->
                        <!-- <li>
                            <a href="doc_patient_lab_vitals.php">My Vitals</a>
                        </li> -->
                        <li>
                            <a href="users_view_prescription.php">View My Prescriptions</a>
                        </li>

                        <li>
                            <a href="users_lab_reports.php">My Lab Reports</a>
                        </li>
                          <li>
                            <a href="users_view_surgery_record.php">My Surgery Status</a>
                        </li>
                        <!--
                        <hr>
                        <li>
                        ...
                        <li>
                            <a href="patient_transfer.php">Patient Transfers</a>
                        </li> -->
                    </ul>
                </li>
                ...
                <!-- doctors can view the lab Report of Patients -->
                <!-- <li>
                    <a href="javascript: void(0);">
                ...
                <!-- doctors can view the his/her pay rolls -->
                <!-- <li>
                    <a href="javascript: void(0);">
