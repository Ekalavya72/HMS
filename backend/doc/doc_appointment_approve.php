        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Aprove Appointment</li>
                                    </ol>
                                </div>
                    ...
                    <?php
                            $pat_number=$_GET['pat_number'];
                            $ret="SELECT  * FROM patients WHERE pat_number='$pat_number'";
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="inputCity" class="col-form-label">Aliment</label>
                                        ...
                                        <button type="submit" name="approve_request" class="ladda-button btn btn-success" data-style="expand-right">Approve Appt.</button>
